...
模型不需要参数量太大，目前感觉prompt设计得好才是关键，4b即可。小于2B的目前没找到好用的，翻译质量不行。
...
**llamacpp**:
- gemma-4-E4B-it-Q4_1（好）

- gemma-4-E2B-it-Q4_K_M (一般般，翻译质量有点差)

- HY-MT1.5-7B-Q4_K_M (还行吧，感觉比不上e4b,但是比e2b好)

- qwen（表现非常不稳定，而且无法禁止思考。）
  - Qwen3.5-9B-Q4_K_M（资源占用太多了）
  - Qwen3.5-2B-Q8_0（翻译质量不行，还不如e2b）
